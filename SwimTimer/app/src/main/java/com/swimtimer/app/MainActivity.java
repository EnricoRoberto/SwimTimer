...
public class MainActivity extends AppCompatActivity {
        ...
        new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton(R.string.save, (d, w) -> {
                    ...
                    SessionStorage.saveSession(this,
                            new SessionData(name, System.currentTimeMillis(), elapsedTime, savedLaps));
    ...
    private void applyThemeButtonColors() {
        int t = themeManager.getCurrentTheme();
        if (t == ThemeManager.THEME_MULTICOLOR) {
    ...
    @Override protected void onDestroy() {
        super.onDestroy(); handler.removeCallbacks(timerRunnable);
    }
}
